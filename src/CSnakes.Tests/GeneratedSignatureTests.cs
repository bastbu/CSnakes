...
public class GeneratedSignatureTests
{
    ...
    [InlineData("async def hello() -> AsyncGenerator[int, str]:\n ...\n", "IAsyncGeneratorIterator<long, string> Hello(CancellationToken cancellationToken = default)")]
    [InlineData("async def hello() -> typing.AsyncGenerator[int, str]:\n ...\n", "IAsyncGeneratorIterator<long, string> Hello(CancellationToken cancellationToken = default)")]
    [InlineData("async def hello() -> collections.abc.AsyncGenerator[int, str]:\n ...\n", "IAsyncGeneratorIterator<long, string> Hello(CancellationToken cancellationToken = default)")]
